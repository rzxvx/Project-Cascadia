#!/bin/sh
# Builds build/mtdump and build/mtlog: armv7 tools for the iPad's own iOS 8.4.1
# (jailbroken, OpenSSH).  mtdump prints what iOS knows about the digitizer,
# mtlog streams AppleMultitouchSPI's own trace -- see the .c files.
#
