...
# ═══════════════════════════════════════════════════════════════
# ТИК ЗАРАБОТАЛ (2026-09-15) — USB SOF
# ═══════════════════════════════════════════════════════════════
...
ничего целевой архитектуры не исполняется. Ключи хоста генерятся на устройстве
через `dropbear -R`; rootfs это ramfs, поэтому ключ новый на каждый буст:
```bash
